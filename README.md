...
4,401 employers tracked · data as of Sep 22, 2026 at 13:40 UTC
...
_Engine (last run): 4,165 of 4,651 registered boards returned successfully across 12 ATS platforms (95% of boards attempted, 89% of the full registry) · completed in 1110.7s · 575 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
