...
4,401 employers tracked · data as of Sep 18, 2026 at 22:51 UTC
...
_Engine (last run): 4,145 of 4,651 registered boards returned successfully across 12 ATS platforms (90% of boards attempted, 89% of the full registry) · completed in 1131.2s · 562 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
